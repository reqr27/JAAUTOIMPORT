...
IF EXISTS (SELECT name FROM sysobjects WHERE name = 'obtener_imagenes_traspasos' AND type = 'P')
DROP PROCEDURE obtener_imagenes_traspasos
GO
create procedure obtener_imagenes_traspasos 
@idVehiculo  int
as
begin
